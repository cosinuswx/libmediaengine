package com.winom.multimedia.source;
...
public class Frame {
    ...
    public Frame(ByteBuffer buffer, BufferInfo bufferInfo) {
        this(buffer, INVALID_INDEX, bufferInfo);
    }

    public Frame(ByteBuffer buffer, int index, BufferInfo bufferInfo) {
        this.buffer = buffer;
        this.bufferIndex = index;
        updateBufferInfo(bufferInfo);
    }

    public void updateBufferInfo(BufferInfo bufferInfo) {
